...
const baseImages = addRepeatedImage('../assets/map/emg4_base.png', 3, 1.0).addTo(map);
const overlayCountries = addRepeatedImage('../assets/map/emg4_countries.png', 3, 1.0).addTo(map);
const overlayRegions = addRepeatedImage('../assets/map/emg4_regions.png', 3, 1.0);
const overlayStates = addRepeatedImage('../assets/map/emg4_states.png', 3, 1.0);
const overlayLabels = addRepeatedImage('../assets/map/emg4_labels.png', 3, 1.0).addTo(map);
